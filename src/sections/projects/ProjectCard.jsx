...
export default function ProjectCard({
  ...
  return (
    <div className="group overflow-hidden rounded-brand-md border border-ink-950/8 bg-white transition-[transform,box-shadow] duration-300 ease-brand hover:-translate-y-1 hover:shadow-[0_20px_40px_-24px_rgba(14,58,43,.35)]">
      <div
